...
export const AboutYou = ({ res }) => {
  ...
  useEffect(() => {
    setDisable({
      ...
      identity_number_type: identity_number_type ? true : false,
          ...
          <Form className="space-y-5">
            ...
            <div className="w-full md:flex justify-center items-center space-y-5 md:space-y-0 md:space-x-6">
              <Select
                ...
                required={true}
                disabled={disable.identity_number_type ? true : false}
            ...
            <div className="md:flex justify-start items-end md:space-x-4 space-y-5 md:space-y-0">
              <FileUpload
                ...
                placeholder={mapPreview ? "1 Photo Uploaded" : "Upload Photo"}
                name="govt_id_photo"
                data={data}
                loading={loading}

...
import { UpdateMaintenanceProvider } from "./UpdateMaintenanceProvider";
...
export const AllMaintenanceProvider = ({ loading, data }) => {
    ...
    <div className="space-y-3">
      {loading ? (
        ...
        paginatedData?.map((item, index) => {
          return (
            ...
            >
              ...
              >
                <UpdateMaintenanceProvider item={item && item} />
              </AccordionBody>
            </Accordion>
          );
        })
        ...
        <div className="w-full flex justify-center items-center h-[40vh] darkText">
          {" "}
          No Maintenance Provider Available...{" "}
        </div>
      )}
      {data.length > 0 && (
        <Pagination
